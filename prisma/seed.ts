...
const categories = [
  { name: "কাচ্চি বিরিয়ানি", slug: "kacchi-biryani", description: "খাসির মাংস ও আলু দিয়ে তৈরি অথেন্টিক বাসমতি কাচ্চি।", image: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8", sortOrder: 1, isActive: true },
  { name: "তেহারি ও পোলাও", slug: "tehari-polao", description: "গরুর মাংস দিয়ে হলুদ তেহারি এবং সুগন্ধি পোলাও।", image: "https://images.unsplash.com/photo-1596560548464-f010549b84d7", sortOrder: 2, isActive: true },
  { name: "চিকেন আইটেম", slug: "chicken-items", description: "গ্রিল, রোস্ট এবং ফ্রাইড চিকেনের বিশাল সমাহার।", image: "https://images.unsplash.com/photo-1598103442097-8b74394b95c6", sortOrder: 3, isActive: true },
  { name: "মাছ ও সি-ফুড", slug: "fish-seafood", description: "তাজা ইলিশ, রুই, চিংড়ির ঝোল ও ভাজা আইটেম।", image: "https://images.unsplash.com/photo-1580959375944-1ab5b8fc22bb", sortOrder: 4, isActive: true },
  { name: "ভর্তা ও ভাত", slug: "vorta-bhaat", description: "গরম ভাতের সাথে ১০ পদের দেশি ভর্তা ও ডাল।", image: "https://images.unsplash.com/photo-1505253758473-96b7015fcd40", sortOrder: 5, isActive: true },
  { name: "পিঠা ও স্ন্যাকস", slug: "pitha-snacks", description: "বিকেলের নাস্তার জন্য ঘরোয়া স্বাদের পিঠা এবং স্ন্যাকস।", image: "https://images.unsplash.com/photo-1601050690597-df0568f70950", sortOrder: 6, isActive: true },
  { name: "ডেজার্ট ও মিষ্টি", slug: "desserts-sweets", description: "খাওয়ার শেষে মিষ্টি মুখ করতে দই, রসমালাই ও পুডিং।", image: "https://images.unsplash.com/photo-1488477181946-6428a0291777", sortOrder: 7, isActive: true },
  { name: "চাইনিজ ও থাই", slug: "chinese-thai", description: "ফ্রাইড রাইস, চাউমিন এবং স্পাইসি থাই স্যুপ।", image: "https://images.unsplash.com/photo-1585032226651-759b368d7246", sortOrder: 8, isActive: true },
  { name: "বার্গার ও স্যান্ডউইচ", slug: "burger-sandwich", description: "জুসি চিকেন বার্গার এবং ক্লাসিক ক্লাব স্যান্ডউইচ।", image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd", sortOrder: 9, isActive: true },
  { name: "জুস ও পানীয়", slug: "juice-drinks", description: "ফ্রেশ ফ্রুট জুস, লাচ্ছি এবং কোল্ড ড্রিংকস।", image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c", sortOrder: 10, isActive: true },
];

const providers = [
  { id: "prov-1", name: "Sultans Kacchi", email: "sultans@kacchi.com", businessName: "সুলতান'স কাচ্চি (Sultan's Kacchi)", description: "আসল বাসমতি চালের শাহি মাটন কাচ্চি এবং বিশেষ বোরহানি।", address: "ধানমন্ডি, ঢাকা", phone: "01711000111", logo: "https://images.unsplash.com/photo-1546548970-71785318a17b" },
  { id: "prov-2", name: "Mayer Doa Catering", email: "mayer@doa.com", businessName: "মায়ের দোয়া ক্যাটারিং", description: "সম্পূর্ণ ঘরোয়া পরিবেশে তৈরি দেশি মাছের ঝোল এবং ১০ পদের ভর্তা।", address: "বনানী, ঢাকা", phone: "01822334455", logo: "https://images.unsplash.com/photo-1556910103-1c02745aae4d" },
  { id: "prov-3", name: "Pitha Puli Corner", email: "pitha@home.com", businessName: "পিঠা পুলি কর্নার", description: "শীতের ভাপা, চিতই এবং পাটিসাপটা পিঠার অথেন্টিক স্বাদ।", address: "মিরপুর, ঢাকা", phone: "01933445566", logo: "https://images.unsplash.com/photo-1589412225853-f097e36279bc" },
  { id: "prov-4", name: "Burger Station", email: "burger@station.com", businessName: "বার্গার স্টেশন", description: "জুসি বিফ বার্গার এবং ক্রিসপি চিকেন ফ্রাই।", address: "গুলশান-২, ঢাকা", phone: "01611223344", logo: "https://images.unsplash.com/photo-1550547660-d9450f859349" },
  { id: "prov-5", name: "Fresh Juice & Desserts", email: "fresh@juice.com", businessName: "ফ্রেশ জুস ও ডেজার্ট", description: "তাজা ফলের জুস, লাচ্ছি এবং বগুড়ার মিষ্টি দই।", address: "উত্তরা, ঢাকা", phone: "01511223344", logo: "https://images.unsplash.com/photo-1460664419185-df9952104041" }
];

const mealItems = [
  // Categories mapped to specific provider index or logic in the seed function
...
const reviewComments = [
  "খুবই স্বাদু এবং ফ্রেশ। পরবর্তীতেও অর্ডার দেব।", "দামের তুলনায় পরিমাণ ভালো। রিকমেন্ড করছি।", "দেরিতে ডেলিভারি হলেও খাবার গরম ছিল।", "পুরান ঢাকার আসল স্বাদ পেয়েছি।", "বোরহানি একদম পারফেক্ট।", "খাসির মাংস নরম এবং মশলাদার।", "পরিবেশন ভালো। প্যাকেজিং ঠিক আছে।", "পরিবারের সবার পছন্দ হয়েছে।", "মাছের ঝোল তরকারি একদম ঘরের মতো।", "বিরিয়ানির চালের কোয়ালিটি অসাধারণ।", "মশলা একদম পারফেক্ট ছিল।", "পরিমাণ কম মনে হয়েছে।", "খুব ভালো লেগেছে। আবার নেব।", "সময়মতো ডেলিভারি হয়েছে।", "দাম একটু বেশি কিন্তু কোয়ালিটি ভালো。"
];
...
async function seedProviders() {
  console.log("Seeding 5 providers...");
  ...
  console.log("✓ 5 Provider profiles seeded successfully.");
}
...
async function seedMeals() {
  ...
  if (profiles.length === 0) {
    console.log("⚠ Meals skipped: No provider profiles found.");
    return;
  }
  ...
  // Helper to find specific provider by business name keyword
  const getProviderId = (keyword: string) => 
    profiles.find(p => p.businessName.includes(keyword))?.id || profiles[0].id;

  let created = 0;
  for (const item of mealItems) {
    const categoryId = slugToId[item.categorySlug] ?? null;
    
    // Assign specific meals to relevant providers
    let targetProviderId = profiles[0].id; // Default
    if (item.categorySlug === "kacchi-biryani") targetProviderId = getProviderId("সুলতান");
    else if (item.categorySlug === "vorta-bhaat" || item.categorySlug === "fish-seafood") targetProviderId = getProviderId("মায়ের দোয়া");
    else if (item.categorySlug === "pitha-snacks") targetProviderId = getProviderId("পিঠা");
    else if (item.categorySlug === "burger-sandwich" || item.categorySlug === "chinese-thai") targetProviderId = getProviderId("বার্গার");
    else if (item.categorySlug === "juice-drinks" || item.categorySlug === "desserts-sweets") targetProviderId = getProviderId("ফ্রেশ");
...
async function seedAdmin() {
  ...
  // Check if admin exists, if not create a skeleton user to promote
  ...
  if (admin) {
    ...
    console.log(`⚠ Admin skip: No user with email "${ADMIN_EMAIL}". Create this user first.`);
  }
}
...
async function seedReviews() {
  ...
  if (users.length === 0 || meals.length === 0) {
    console.log("⚠ Reviews skipped: Need users and meals first.");
    return;
  }
  ...
  for (const user of users) {
    const reviewsPerUser = Math.floor(Math.random() * 5) + 1;
    for (let i = 0; i < reviewsPerUser && created < targetReviews; i++) {
      const randomMeal = meals[Math.floor(Math.random() * meals.length)];
      const rating = Math.random() > 0.2 ? (4 + Math.floor(Math.random() * 2)) : (2 + Math.floor(Math.random() * 2));
...
async function main() {
  ...
  await seedProviders(); // Must run before meals
  await seedMeals();
  await seedAdmin();
  await seedReviews();
